    ...
    return <div className="footer">
        <div className="foot"><div className="contact">
            ...
            <div className="WhatsTele">
                ...
                <a href="https://t.me/stackviewbr" className="t"><img
                    id="t"
                    alt="telegram"
                    src="/icons/tel.png"
                    width="50px"
            ...
            <div className="follow">
                ...
                <div className="line">
                    ...
                    /></a>
                    <a href="https://www.instagram.com/g_lisbao/"><img
                        id="insta"
                        alt="instagram"
                        src="/icons/insta.png"
                        width="50px"
                    ...
                    /></a>
                    <a href="https://github.com/StackView-BR"><img
                        id="git"
                        alt="github"
                        src="/icons/git.png"
                        width="50px"
                    ...
                    /></a>
                    <a href="https://www.facebook.com/lisbao.gabriel/"><img
                        id="face"
                        alt="facebook"
                        src="/icons/face.png"
                        width="50px"
                    ...
                    /></a>
                    <a href="https://www.linkedin.com/in/gabrielelisbao/"><img
                        id="in"
                        alt="linkedin"
                        src="/icons/in.png"
                        width="50px"
